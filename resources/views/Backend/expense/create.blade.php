    ...
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="my-2 pull-left">
                <h4 class="text-blue h4">Create Expense Section</h4>
            </div>
        </div>
        <form action="{{ route('admin.expense.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Expense Reason</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" name="expense_reason" type="text" value="{{ old('expense_reason') }}" />
